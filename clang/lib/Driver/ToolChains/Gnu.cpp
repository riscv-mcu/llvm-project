...
static void findRISCVBareMetalMultilibs(const Driver &D,
  ...
  constexpr RiscvMultilib RISCVMultilibSet[] = {
      ...
      {"rv32ima_zca_zcb_zcmp_zcmt", "ilp32"}, {"rv32imaf_zca_zcb_zcf_zcmp_zcmt", "ilp32f"}, {"rv32imafd_zca_zcb_zcf_zcmp_zcmt", "ilp32d"}, {"rv32imafd_zca_zcb_zcf_zcd", "ilp32d"},
      {"rv32ima_zca_zcb_zcmp_zcmt_zba_zbb_zbc_zbs", "ilp32"}, {"rv32imaf_zca_zcb_zcf_zcmp_zcmt_zba_zbb_zbc_zbs", "ilp32f"},
      {"rv32imafd_zca_zcb_zcf_zcmp_zcmt_zba_zbb_zbc_zbs", "ilp32d"}, {"rv32imafd_zca_zcb_zcf_zcd_zba_zbb_zbc_zbs", "ilp32d"},
      ...
      {"rv64ima_zca_zcb_zcmp_zcmt", "lp64"}, {"rv64imaf_zca_zcb_zcmp_zcmt", "lp64f"}, {"rv64imafd_zca_zcb_zcmp_zcmt", "lp64d"},
      {"rv64ima_zca_zcb_zcmp_zcmt_zba_zbb_zbc_zbs", "lp64"}, {"rv64imaf_zca_zcb_zcmp_zcmt_zba_zbb_zbc_zbs", "lp64f"},
